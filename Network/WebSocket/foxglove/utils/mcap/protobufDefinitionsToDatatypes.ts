...
export function protobufDefinitionsToDatatypes(datatypes: MessageDefinitionMap, type: protobufjs.Type): void {
  ...
  for (const field of type.fieldsArray) {
    ...
    } else if (type.fullName === ".google.protobuf.Timestamp" || type.fullName === ".google.protobuf.Duration") {
      definitions.push({
        type: "int32",
